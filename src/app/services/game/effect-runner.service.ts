...
export class EffectRunnerService {
  ...
  async run(effect: Effect, ctx: EffectContext): Promise<void> {
    ...
    switch (effect.type) {
      case 'customTestLog': {
        console.log('TEST EFFECT:', effect);
        return;
      }

      case 'modifyStat': {
        console.log('[ ACTION RUN ]: modifyStat', effect);
      ...
      case 'consumeItem': {
        console.log('[ ACTION RUN ]: consumeItem', effect);
      ...
      case 'movePlayers': {
        console.log('[ ACTION RUN ]: movePlayers', effect);
        // const { playerIds, destinationId } = effect.payload;
        // const ent = mission.entities?.[destinationId];
      ...
      case 'applyStatus': {
        console.log('[ ACTION RUN ]: applyStatus', effect);
      ...
      case 'giveItem': {
        console.log('[ ACTION RUN ]: giveItem', effect);
